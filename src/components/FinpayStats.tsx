        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          >
            <div className="text-center mb-12">
              <h2 className="text-4xl font-bold text-foreground mb-4">Why they prefer Finpay</h2>
            </div>
            ...
            <div className="space-y-12">
              ...
              >
                ...
                <div className="text-muted-foreground font-medium">Businesses already running on Finpay</div>
              </motion.div>
          ...
          >
            <motion.div
              ...
              className="bg-card rounded-2xl p-8 shadow-sm border border-border"
            >
              <h3 className="text-xl font-bold text-foreground mb-4">No asset volatility</h3>
              <p className="text-muted-foreground mb-6">
                Reduce payment costs and use a budget management tool within your own workplace.
              </p>
              <div className="text-3xl font-bold text-foreground">$1,676,580</div>
            </motion.div>
              ...
              <div className="flex items-end space-x-2 h-32">
                {[30, 45, 35, 60, 80, 65, 85, 75, 90].map((height, index) => (
                  <motion.div
                    ...
                    className="bg-teal-200 dark:bg-teal-800 flex-1 rounded-t-sm"
                  />
                ))}
              </div>
